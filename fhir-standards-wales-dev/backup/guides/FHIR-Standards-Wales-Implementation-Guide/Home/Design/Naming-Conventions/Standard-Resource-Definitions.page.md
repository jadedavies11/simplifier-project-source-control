...
<table class="table table-striped">
	...
	<tbody>
        ...
        <tr>
			...
			<td><b><span style="color:#0070c0;">{[Discriminator]}</span> Data Standards Wales<span style="color:#c00000;"> [BusinessName]</span></b></td>
...
<div class="tab-wrap">
  ...
  <div class="tab-main">
    <div id="tabsrdglossary" class="tabcontent active">
       {{page:SRD-Glossary}}
    </div>
