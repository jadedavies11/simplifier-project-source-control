---
usagetype: '"Appointment identity" or "Appointment identity, Encounter identity, ServiceRequest identity" or "Attendance identifier"'
---

<div class="warning"><span class="ImplementWarn"></span></div>
or 'Appointment identity, Encounter identity, ServiceRequest identity' or 'Attendance identifier' 
# {{page-title}}
...
Data Standards Wales is responsible for the creation of namespaces and OIDs for NHS Wales systems. If you require one to be created please contact them using the email on the {{pagelink:Help-and-Support,text:help and support}} page and ask for the link to the request form (internal to NHS Wales).
...
<fql output='table'>
  from
    NamingSystem
  where
    usage='Appointment identity, Encounter identity, ServiceRequest identity' or 'Attendance identifier'
  select
    uniqueId[0].value,
    name,
    description,
