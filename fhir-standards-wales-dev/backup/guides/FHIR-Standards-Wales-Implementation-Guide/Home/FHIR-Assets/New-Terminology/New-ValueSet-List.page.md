...
<table class="table table-striped" style="table-layout: fixed;">
  ...
  <thead>
	...
	<tr>
		...
		<td></td>
		<td></td>
		<td>Embedded in<br>{{pagelink:ValueSet-DataStandardsWales-ObservationVitalSignsType}}</td>
	</tr>
	<tr>
	...
	<tr>
		<td scope="row">{{pagelink:ValueSet-DataStandardsWales-DocumentAttribute, text: DataStandardsWales-DocumentAttribute}}</td>
	...
	<tr>
		<td scope="row">{{pagelink:ValueSet-DataStandardsWales-DocumentErrorAction, text: DataStandardsWales-DocumentErrorAction}}</td>
		...
		<tr>
		<td scope="row">{{pagelink:ValueSet-DataStandardsWales-DocumentErrorStatus, text: DataStandardsWales-DocumentErrorStatus}}</td>
	...
	<tr>
		<td scope="row">{{pagelink:ValueSet-DataStandardsWalesPatientRecordType, text: DataStandardsWalesPatientRecordType}}</td>
		<td></td>
	...
	<tr>
		...
		<td>{{pagelink:CodeSystem-DataStandardsWales-ProvenanceActivity, text: DataStandardsWales-ProvenanceActivity}}</td>
		<td></td>
		<td></td>
		<td>For CDR use only and not bound to a profile in the IG</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>{{pagelink:DataStandardsWales-MessageDefinition}}</td>
		<td>MessageDefinition.event</td>
		<td>Embedded in<br>{{pagelink:ValueSet-DataStandardsWales-MessageEvent}}</td>
	</tr>
	<tr>
		<td scope="row">{{pagelink:ValueSet-MessageEvents, text: MessageEvents}}</td>
		<td>{{pagelink:CodeSystem-MessageEvents, text: MessageEvents}}</td>
	...
	<tr>
		...
		<td>{{pagelink:CodeSystem-WPASReferralSource, text: WPASReferralSource}}<br>
		&nbsp;SNOMED CT</td>
		<td></td>
		<td></td>
		<td>For CDR/ NHS App use only and not bound to a profile in the IG.<br>The SCT codes are
