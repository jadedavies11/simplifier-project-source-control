...
Set</a>
	...
	<tr>
		...
		<td>{{pagelink:CodeSystem-DataStandardsWales-RecordingSetting, text: DataStandardsWales-RecordingSetting}}</td>
		<td></td>
		<td>{{pagelink:DataStandardsWales-VitalSigns}}</td>
	...
	<tr>
		...
		<td>{{pagelink:CodeSystem-DataStandardsWales-RecordingSetting, text: DataStandardsWales-RecordingSetting}}</td>
		<td></td>
		<td>{{pagelink:DataStandardsWales-VitalSigns-BMI}}</td>
		<td>Observation.extension:recordingSetting</td>
		<td></td>
	</tr>
	<tr>
		...
		<td>{{pagelink:CodeSystem-DataStandardsWales-RecordingSetting, text: DataStandardsWales-RecordingSetting}}</td>
		<td></td>
		<td>{{pagelink:DataStandardsWales-VitalSigns-BodyHeight}}</td>
		<td>Observation.extension:recordingSetting</td>
		<td></td>
	</tr>
	<tr>
		...
		<td>{{pagelink:CodeSystem-DataStandardsWales-RecordingSetting, text: DataStandardsWales-RecordingSetting}}</td>
		<td></td>
		<td>{{pagelink:DataStandardsWales-VitalSigns-BodyWeight}}</td>
		<td>Observation.extension:recordingSetting</td>
		<td></td>
	</tr>
	<tr>
