The following Data Standard Wales Value Sets are composed of Code System `http://snomed.info/sct`.
...
<table class="table table-striped" style="table-layout: fixed;">
  ...
  <thead>
	...
	<tr>
		...
		<td></td>
		<td></td>
		<td style="font-size: 90%;">Embedded in {{pagelink:ValueSet-DataStandardsWales-ObservationVitalSignsType}}</td>
	</tr>
	<tr>
