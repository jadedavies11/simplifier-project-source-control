...
<table class="table table-striped" style="table-layout: fixed;">
  ...
  <thead>
	...
	<tr>
		...
		<td>
			<a href="https://hl7.org/fhir/valueset-composition-attestation-mode.html">composition-attestation-mode</a><br>
			<a href="https://hl7.org/fhir/codesystem-composition-attestation-mode.html">composition-attestation-mode</a>
		</td>
		<td>CodeableConcept<br>dateTime<br>Reference</td>
		<td></td>
		<td>R5</td>
	</tr>
	<tr>
		...
		<td>{{pagelink:ValueSet-DataStandardsWales-DocumentAttribute, text:DataStandardsWales-DocumentAttribute}}<br>
		{{pagelink:CodeSystem-DataStandardsWales-DocumentAttribute, text:DataStandardsWales-DocumentAttribute}}</td>
		<td>code<br>string</td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		...
		<td>{{pagelink:ValueSet-DataStandardsWales-DocumentDigitalStatus, text:DataStandardsWales-DocumentDigitalStatus}}<br>
		{{pagelink:CodeSystem-DataStandardsWales-DocumentDigitalStatus, text:DataStandardsWales-DocumentDigitalStatus}}</td>
		<td>code</td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		...
		<td>{{pagelink:ValueSet-DataStandardsWales-DocumentErrorAction, text:DataStandardsWales-DocumentErrorAction}}<br>{{pagelink:CodeSystem-DataStandardsWales-DocumentErrorAction, text:DataStandardsWales-DocumentErrorAction}}</td>
		<td>code<br>instant<br>Reference<br>CodeableConcept</td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		...
		<td>{{pagelink:ValueSet-DataStandardsWales-DocumentErrorStatus, text:DataStandardsWales-DocumentErrorStatus}}<br>{{pagelink:CodeSystem-DataStandardsWales-DocumentErrorStatus, text:DataStandardsWales-DocumentErrorStatus}}</td>
		<td>code</td>
		<td></td>
		<td></td>
	</tr>
	...
	<tr>
		...
		<td>
			<a href="https://simplifier.net/packages/fhir.r4.ukcore.stu2/2.0.1/files/2483924">UKCore-PracticeSettingCode</a><br>
	...
	<tr>
		...
		<td>{{pagelink:ValueSet-DataStandardsWales-UEC-AttendanceCategory, text:DataStandardsWales-UEC-AttendanceCategory}}<br>
		{{pagelink:CodeSystem-DataStandardsWales-UEC-AttendanceCategory, text:DataStandardsWales-UEC-AttendanceCategory}}
		</td>
		<td>CodeableConcept</td>	
		<td>
...
Set</a>
	...
	<tr>
		...
		<td>{{pagelink:ValueSet-DataStandardsWales-UEC-ArrivalMode, text:DataStandardsWales-UEC-ArrivalMode}}<br>
		&nbsp;SNOMED CT	
		</td>
		<td>Coding</td>
		<td>
...
Set</a>
	...
	<tr>
		...
		<td>extension:immunizationBasedOnR5</td>
		<td></td>
		<td>Reference</td>
		<td></td>
		<td>R5</td>
	...
	<tr>
		...
		<td>
			<a href="https://terminology.hl7.org/7.0.1/ValueSet-medicationrequest-course-of-therapy.html">Medication request course of therapy codes</a><br>
	...
	<tr>
		...
		<td>{{pagelink:ValueSet-DataStandardsWales-RecordingSetting,text:DataStandardsWales-RecordingSetting}}<br>
		{{pagelink:CodeSystem-DataStandardsWales-RecordingSetting,text:DataStandardsWales-RecordingSetting}}</td>
		<td>CodeableConcept</td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		...
		<td>{{pagelink:ValueSet-DataStandardsWales-BodyPosition, text:DataStandardsWales-BodyPosition}}<br>
		&nbsp;SNOMED CT
		</td>
		<td>CodeableConcept</td>
		<td></td>
	...
	<tr>
		...
		<td>{{pagelink:ValueSet-DataStandardsWales-Occupation, text:DataStandardsWales-Occupation}}<br>
		&nbsp;SNOMED CT
		</td>
		<td>CodeableConcept</td>
		<td>
	...
	<tr>
		...
		<td>{{pagelink:ValueSet-DataStandardsWales-Religion, text:DataStandardsWales-Religion}}<br>
		&nbsp;SNOMED CT
		</td>
		<td>CodeableConcept</td>
		<td>
	...
	<tr>
		...
		<td>Address<br>code<br>HumanName<br>dateTime<br>Identifier</td>
		<td></td>
		<td></td>
	</tbody>
</table>