...
<table class="table table-striped" style="table-layout: fixed;">
  ...
  <thead>
	...
	<tr>
		...
		<td>{{pagelink:ValueSet-FHIRStandardsWales-DocumentAttribute, text:FHIRStandardsWales DocumentAttribute}}<br>
		{{pagelink:CodeSystem-FHIRStandardsWales-DocumentAttribute, text:FHIRStandardsWales DocumentAttribute}}</td>
