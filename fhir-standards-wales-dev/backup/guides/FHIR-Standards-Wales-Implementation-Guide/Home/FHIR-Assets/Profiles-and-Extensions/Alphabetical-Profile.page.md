...
<tbody>
	...
	<tr>
		<td scope="row">{{pagelink:DataStandardsWales-HealthcareService}}</td>
		<td>
			<a href="https://simplifier.net/guide/UK-Core-Implementation-Guide-STU2/Home/ProfilesandExtensions/Profile-UKCore-HealthcareService?version=2.0.2">UKCore-HealthcareService</a>
		</td>
		<td><a class="tagdraft" target="_blank">Draft</a></td>
		<td>0.1.0</td>
	</tr>
	...
	<tr>
		...
		<tr>
		<td scope="row">{{pagelink:DataStandardsWales-OrganizationAffiliation}}</td>
		<td>
			<a href="https://www.hl7.org/fhir/R4/organizationaffiliation.html">OrganizationAffiliation</a>
		</td>
		<td><a class="tagdraft" target="_blank">Draft</a></td>
		<td>0.1.0</td>
	</tr>
	...
	<tr>
		...
		<tr>
		<td scope="row">{{pagelink:DataStandardsWales-Task}}</td>
		<td>
			<a href="https://www.hl7.org/fhir/R4/task.html">Task</a>
		</td>
		<td><a class="tagdraft" target="_blank">Draft</a></td>
		<td>0.1.0</td>
	</tr>
