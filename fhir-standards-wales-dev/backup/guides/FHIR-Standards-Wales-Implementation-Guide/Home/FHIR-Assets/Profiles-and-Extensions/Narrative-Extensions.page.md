...
<table class="table table-striped" style="table-layout: fixed;">
  ...
  <thead>
	...
	<tr>
		<td scope="row">{{pagelink:Extension-DataStandardsWales-GridReference}}</td>
		<td>{{pagelink:DataStandardsWales-Location}}</td>
		<td style="font-size: 90%;">Location.extension:gridReference</td>
		<td></td>
	</tr>
	<tr>
		<td scope="row">{{pagelink:Extension-DataStandardsWales-LocationPeriod}}</td>
		<td>{{pagelink:DataStandardsWales-Location}}</td>
		<td style="font-size: 90%;">Location.extension:locationPeriod</td>
		<td></td>
	</tr>
	<tr>
