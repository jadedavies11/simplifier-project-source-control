...
<div class="tab-wrap">
  ...
  <div id="tabeg" class="tabcontent">
    <list>
      <li>{{pagelink:Example-OrganizationAffiliation-CC201-W00142, text:Example Cluster Affiliation - Amman Gwendraeth and Amman Tawe Partnership}}</li>
      <li>{{pagelink:Example-OrganizationAffiliation-R3D8C-7A3, text:Example Region Affiliation - South Central Wales Region and SBUHB}}</li>
    </list>
  </div>
</div>
