...
The {{page-title}} profile is derived from the [HL7 R4 ImagingStudy Standard](https://hl7.org/fhir/R4/imagingstudy.html). It defines additional rules for use within health and care organisations in Wales.
