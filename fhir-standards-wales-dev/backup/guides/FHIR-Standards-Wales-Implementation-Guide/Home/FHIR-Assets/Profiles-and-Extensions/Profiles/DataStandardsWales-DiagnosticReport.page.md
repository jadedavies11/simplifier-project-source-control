 ...
 * Please see {{pagelink:DataStandardsWales-DiagnosticReport-Lab, text: Data Standards Wales DiagnosticReport Profile for Laboratory results}} for examples of Pathology/Laboratory results.
