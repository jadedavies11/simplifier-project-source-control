...
* A name
  * The `Location.name` field **SHOULD** be populated if a name exists for the location.  <br /><br />
...
* An identifier*
  * The `Location.identifier` field **SHOULD** contain all available identifiers. Typical identifiers include:
    ...
    * Identifiers assigned by a hospital PAS or other clinical system.
    * General location dentifiers such as Global Location Number (GLN) or what3words.  <br /><br />
