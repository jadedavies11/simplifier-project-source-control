...
The {{page-title}} profile is derived from the [HL7 R4 Provenance](https://www.hl7.org/fhir/r4/provenance.html). It defines additional rules for use within health and care organisations in Wales.
...
<div class="tab-wrap">
  ...
  <div id="tabeg" class="tabcontent">
    <list>
        <li>{{pagelink:Example-Provenance-DemographicsAsRecorded, text:Example Provenance record showing the DemographicsAsRecorded extension}}</li>
        <li>{{pagelink:Example-Provenance-DemographicUpdate, text:Example Provenance record linked to a Patient demographic update as result of an HL7v2 patient demographic update }}</li>
        <li>{{pagelink:Example-Provenance-DocumentReferenceCreation, text: Example Provenance record for DocumentReference creation}}</li>
        <li>{{pagelink:Example-Provenance-DocumentReferenceDemographics, text: Example Provenance record for demographics as recorded with care document}}</li>
        <li>{{pagelink:Example-Provenance-MultipleTargets, text:Example Provenance record with multiple targets e.g. for growth chart observations}}</li>
        <li>{{pagelink:Example-DocumentReference-Provenance, text:Example Document Reference - Provenance-related HL7v2 message}}</li>
    </list>
  </div>
</div>
