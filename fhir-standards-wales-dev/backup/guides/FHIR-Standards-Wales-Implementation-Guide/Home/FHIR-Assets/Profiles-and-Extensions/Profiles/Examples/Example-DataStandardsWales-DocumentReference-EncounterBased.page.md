...
NOTE that the example is illustrative of DocumentReference content in the case that an Encounter exists.  That {{pagelink:Example-DataStandardsWales-Encounter-DocumentedEvent-DiabetesConsultation, text:Encounter}} holds the document metadata items that relate to the event such as event location and senior responsible clinician.
