...
<table class="table table-striped" style="table-layout: fixed;">
  ...
  <thead>
	...
	<tr>
		...
		<td>{{pagelink:Extension-DataStandardsWales-AliasType}}</td>
	...
	<tr>
		<td scope="row">{{pagelink:DataStandardsWales-Location}}</td>
		<td>{{pagelink:Extension-DataStandardsWales-GridReference}}</td>
		<td style="font-size: 90%;">extension:gridReference</td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		<td scope="row">{{pagelink:DataStandardsWales-Location}}</td>
		<td>{{pagelink:Extension-DataStandardsWales-LocationPeriod}}</td>
		<td style="font-size: 90%;">extension:locationPeriod</td>
		<td></td>
		<td></td>
	</tr>
	<tr>
    ...
    <tr>
	    ...
	    <tr>
		<td scope="row">{{pagelink:DataStandardsWales-Organization}}</td>
		<td>{{pagelink:Extension-DataStandardsWales-SuccessorOrganization}}</td>
		<td style="font-size: 90%;">extension:successorOrganization</td>
		<td></td>
		<td></td>
	</tr>
	<tr>
