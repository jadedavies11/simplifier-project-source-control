...
<table class="table table-striped" style="table-layout: fixed;">
  ...
  <thead>
	...
	<tr>
		...
		<td class="font-size: 90%;">Immunization.extension:administeredProduct</td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
		<tr>
		<td scope="row">{{pagelink:Extension-DataStandardsWales-AliasType, text: DataStandardsWales-AliasType}}</td>
		<td>{{pagelink:DataStandardsWales-Organization}}</td>
		<td class="font-size: 90%;">Organization.alias.extension:aliasType</td>
	...
	<tr>
		...
		<td class="font-size: 90%;">Appointment.extension:clinicCode</td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		...
		<td>{{pagelink:DataStandardsWales-Immunization}}</td>
		<td class="font-size: 90%;">Immunization.extension:dateProcedureLastUpdated</td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		...
		<td class="font-size: 90%;">Provenance.extension:extensionDataStandardsWalesDemographicsAsRecorded</td>
		<td>
	...
	<tr>
		...
		<td class="font-size: 90%;">DocumentReference.extension:digitalStatus</td>
	...
	<tr>
		...
		<td>{{pagelink:DataStandardsWales-Immunization}}</td>
		<td class="font-size: 90%;">Immunization.extension:forecastCreationSource</td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		...
		<td class="font-size: 90%;">MedicationStatement.extension:medicationCourseOfTherapyType</td>
		<td>
	...
	<tr>
		...
		<td class="font-size: 90%;">List.extension:SingleRecordAllergiesListConfirmedBy</td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		...
		<td>{{pagelink:DataStandardsWales-AllergyList}}</td>
		<td class="font-size: 90%;">List.extension:SingleRecordAllergiesListConfirmedDate</td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		...
		<td>{{pagelink:DataStandardsWales-AllergyList}}</td>
		<td class="font-size: 90%;">List.extension:SingleRecordAllergiesListUpdated</td>
		<td></td>
		<td></td>
		<td></td>
	</tr>
	<tr>
		...
		<td class="font-size: 90%;">Encounter.extension:Speciality</td>
		<td>
	...
	<tr>
		...
		<td>{{pagelink:DataStandardsWales-Encounter-UEC}}</td>
		<td class="font-size: 90%;">Encounter.extension:uecAttendanceCategory</td>
	...
	<tr>
		...
		<td>{{pagelink:DataStandardsWales-Encounter-UEC}}</td>
		<td class="font-size: 90%;">Encounter.extension:uecDischargeInformationGiven</td>
		<td></td>
		<td></td>	
		<td></td>
	</tr>
	<tr>
		...
		<td>{{pagelink:DataStandardsWales-Encounter-UEC}}</td>
		<td class="font-size: 90%;">Encounter.extension:uecExpectedTimeOfTreatment</td>
		<td></td>
		<td></td>	
		<td></td>
	</tr>
	<tr>
		...
		<td>{{pagelink:DataStandardsWales-Encounter-UEC}}</td>
		<td class="font-size: 90%;">Encounter.extension:modeOfArrival</td>
