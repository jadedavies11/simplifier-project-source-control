...
The following Extensions contain Welsh coded assets.
	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				&nbsp;<span style="font-size: 90%;">SNOMED CT</span>
			</td>
			<td>Preferred</td>
		</tr>
		<tr>
		...
		<td scope="row">
			...
			<td>
				...
				<a href="https://simplifier.net/packages/fhir.r4.ukcore.stu2/2.0.1/files/2483907">UKCore-NHSNumberVerificationStatusEngland</a><br>
