...
The following Extensions are backports and used in the implementation guide.
  ...
  <thead>
	...
	<tbody>
		<tr>
			...
			<td style="font-size: 90%;">DocumentReference.extension:attesterR5</td>
			<td>
		...
		<tr>
			...
			<td>{{pagelink:DataStandardsWales-DocumentReference}}</td>
			<td style="font-size: 90%;">DocumentReference.extension:versionR5</td>
			<td></td>
			<td></td>
		</tr>
			...
			<td style="font-size: 90%;">Immunization.extension:immunizationBasedOnR5</td>
			<td></td>
			<td></td>
		</tr>
		<tr>
			...
			<td style="font-size: 90%;">DiagnosticReport.extension:compositionReferenceR5</td>
			<td></td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>{{pagelink:DataStandardsWales-DiagnosticReport}}</td>
			<td style="font-size: 90%;">DiagnosticReport.extension:noteR5</td>
			<td></td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>{{pagelink:DataStandardsWales-DiagnosticReport}}</td>
			<td style="font-size: 90%;">DiagnosticReport.extension:supportingInfoR5</td>
			<td>
		...
		<tr>
			...
			<td style="font-size: 90%;">Observation.extension:bodyStructureR5</td>
			<td></td>
			<td></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>{{pagelink:DataStandardsWales-Observation}}</td>
			<td style="font-size: 90%;">Observation.extension:triggeredByR5</td>
			<td>
		...
		<tr>
			...
			<td style="font-size: 90%;">Specimen.collection.collector.extension:collectionCollectorR5</td>
			<td></td>
			<td></td>
		</tr>
	</tbody>
