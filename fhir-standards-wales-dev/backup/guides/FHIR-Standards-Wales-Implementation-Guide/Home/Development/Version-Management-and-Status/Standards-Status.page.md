...
* Starting as **Draft** which provides insight into future versions and is a place-holder for feedback
* Moves to **Trial Use** for real-world testing
* Becomes **Normative** when stable and locked for backward compatibility
* Eventually may be **Deprecated** when retired
