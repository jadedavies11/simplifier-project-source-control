...
## FHIR Resources
### Device
The source system that provided the document details will be represented as a Device resource instance. In the case of autogenerated documents, a Device may also be represented as the author. 
