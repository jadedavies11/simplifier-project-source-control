...
<div class="tab-wrap">
  <ul class="tab-head">
    ...
    <li class="tablink" onclick="openLocalTab(this,'tabdatamodel1')" data-target="tabdatamodel1">
      Messaging Data Model
    </li>   
    <li class="tablink" onclick="openLocalTab(this,'tabmsgdefinition1')" data-target="tabmsgdefinition1">
      Message Definition
    </li>  
    <li class="tablink" onclick="openLocalTab(this,'tabbundle1')" data-target="tabbundle1">
      Example Bundle
    </li>  
  </ul>
  <div class="tab-main">
